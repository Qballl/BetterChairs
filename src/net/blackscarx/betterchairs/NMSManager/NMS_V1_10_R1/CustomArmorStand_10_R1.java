...
public class CustomArmorStand_10_R1 extends EntityArmorStand
{

    private boolean protect = true;

    public CustomArmorStand_10_R1(World world)
    {
        super(world);
    }
    ...
    public static ArmorStand spawn(Location location, Player p)
    {
        ...
        CustomArmorStand_10_R1 customEntity = new CustomArmorStand_10_R1(mcWorld);
    ...
    private boolean shouldDie(CustomArmorStand_10_R1 mount)
    {
