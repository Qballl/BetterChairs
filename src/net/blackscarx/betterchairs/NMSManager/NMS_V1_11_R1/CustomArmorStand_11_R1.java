package net.blackscarx.betterchairs.NMSManager.NMS_V1_11_R1;
...
public class CustomArmorStand_11_R1 extends EntityArmorStand
{

    private boolean protect = true;

    public CustomArmorStand_11_R1(World world)
    {
        super(world);
    }
    ...
    public static ArmorStand spawn(Location location, Player p)
    {
        ...
        CustomArmorStand_11_R1 customEntity = new CustomArmorStand_11_R1(mcWorld);
    ...
    private boolean shouldDie(CustomArmorStand_11_R1 mount)
    {
