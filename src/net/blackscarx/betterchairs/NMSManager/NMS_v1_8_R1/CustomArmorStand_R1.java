 ...
 */
package net.blackscarx.betterchairs.NMSManager.NMS_v1_8_R1;
...
public class CustomArmorStand_R1 extends EntityArmorStand
{

    private boolean protect = true;

    public CustomArmorStand_R1(World world)
    {
        super(world);
    }
    ...
    public static ArmorStand spawn(Location location, Player p)
    {
        ...
        CustomArmorStand_R1 customEntity = new CustomArmorStand_R1(mcWorld);
    ...
    private boolean shouldDie(CustomArmorStand_R1 mount)
    {
