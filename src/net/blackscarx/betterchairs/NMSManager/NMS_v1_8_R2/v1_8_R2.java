...
public class v1_8_R2 implements NMS
{
    ...
    {
        return CustomArmorStand_R2.spawn(loc, p);
    }
    ...
    public void kill(ArmorStand armorStand)
    {
        ...
        ((CustomArmorStand_R2) nmsArmor).killArmorStand();
    }
    ...
    {
        return ((CraftArmorStand) armorStand).getHandle() instanceof CustomArmorStand_R2;
    }
