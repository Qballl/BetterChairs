...
public class v1_9_R1 implements NMS
{
    ...
    {
        return CustomArmorStand_9_R1.spawn(loc, p);
    }
    ...
    public void kill(ArmorStand armorStand)
    {
        ...
        ((CustomArmorStand_9_R1) nmsArmor).killArmorStand();
    }
    ...
    {
        return ((CraftArmorStand) armorStand).getHandle() instanceof CustomArmorStand_9_R1;
    }
