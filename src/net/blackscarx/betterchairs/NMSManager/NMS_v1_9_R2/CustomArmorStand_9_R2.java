 ...
 */
package net.blackscarx.betterchairs.NMSManager.NMS_v1_9_R2;
...
public class CustomArmorStand_9_R2 extends EntityArmorStand
{

    private boolean protect = true;

    public CustomArmorStand_9_R2(World world)
    {
        super(world);
    }
    ...
    public static ArmorStand spawn(Location location, Player p)
    {
        ...
        CustomArmorStand_9_R2 customEntity = new CustomArmorStand_9_R2(mcWorld);
    ...
    private boolean shouldDie(CustomArmorStand_9_R2 mount)
    {
